...
{	
	...
	do{
		...
		printf("4.Them mot phan tu vao cuoi mang, phan tu moi them vao mang phai do nguoi dung nhap vao\n");
		printf("5.Xoa phan tu tai mot vi tri cu the (nguoi dung nhap vi tri)\n");
